...
input[type=password],input[type=text],input[type=number]{width:100%;padding:13px;border-radius:9px;border:1px solid #4e6254;background:#111813;color:inherit;font:inherit}
...
<div class="row"><label for="debounce">等待你说完（秒）</label></div><input id="debounce" type="number" min="0" max="300" step="1" required value="30"><small>每收到一条消息重新计时，安静这么久后一起回复。默认 30 秒，设为 0 则逐条处理。回复的消息块间隔至少 2 秒。</small>
